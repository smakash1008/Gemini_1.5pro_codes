...
instruction = "Behave like the best data scrapper and give the final data in the below csv format mentioned in the prompt."
...
with open('csvdata1.csv','w') as newfile:
