...
instruction = "Analyze the Photo or Group of Photos provided by the user and give the details correctly to the user whatever they want."
...
prompt = "Write a detailed description based on the picture. List all the items in the picture strictly without fail. It should include the description of the items also in a detailed way about 2 sentences compulsorily."
