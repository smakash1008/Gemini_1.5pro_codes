...
cache = caching.CachedContent.create(
    ...
    display_name="Short-Answers.pdf",
...
model = genai.GenerativeModel.from_cached_content(cached_content=cache, generation_config=genai.GenerationConfig(
    temperature=1,
    top_p=0.95,
    top_k=64,
...
for cac in caching.CachedContent.list():
    print(cac)
