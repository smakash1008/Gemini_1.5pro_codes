...
instruction = "Behave like a best coder and give the details of the code in steps briefly as requested by the user."
...
def upload_to_gemini(file_path):
    file = genai.upload_file(file_path, mime_type='text/plain')
